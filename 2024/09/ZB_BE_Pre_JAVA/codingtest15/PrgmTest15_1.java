 ...
 */
public class PrgmTest15_1 {
    public static final String[] testArr1 = {"abc", "def", "ghi"};
    public static final String[] testArr2 = {"abc", "bbc", "cbc"};

    public static void main(String[] args) {
        System.out.println("=".repeat(50));

        System.out.println(new Solution15_1().solution(testArr1, "ef"));
        System.out.println(new Solution15_1().solution(testArr2, ""));
    }
}
