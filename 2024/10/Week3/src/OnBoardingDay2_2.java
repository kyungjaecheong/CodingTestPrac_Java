 ...
 */
public class OnBoardingDay2_2 {

    public static int[] solution(int[] progresses, int[] speeds) {
        Queue<Integer> remainDays = new ArrayDeque<>();
        ...
        while (!remainDays.isEmpty()) {
            int basis = remainDays.poll();
            int cnt = 1;

            while (!remainDays.isEmpty() && remainDays.peek() <= basis) {
                remainDays.poll();
                cnt++;
            }
    ...
    public static void main(String[] args) {
        ...
        int[] speeds1 = {1, 30, 5}; // [2, 1]
        int[] progresses2 = {95, 90, 99, 99, 80, 99};
        int[] speeds2 = {1, 1, 1, 1, 1, 1}; // [1, 3, 2]
